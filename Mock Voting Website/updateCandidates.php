...
<body>
    <div id='wrapper'>
        ...
        <div class="container">
        <h2>Update Candidates Details</h2>
        ...
        <?php
            ...
            $sql = "select candidate_id from candidates where candidate_id = '$getID';";
            $result = mysqli_query($conn, $sql);
            $row = $result->fetch_assoc();
            echo "Candidate ID: ".$row['candidate_id']."<br><br>";
            $_SESSION['canId'] = $row['candidate_id'];
            $conn->close(); //close the connection
        
        ?>
        <form action="processCandidateUpdate.php" method="post">
            Candidate Name: <br><br>
            <input type="text" name="candidateName"><br><br>
            Party Name: <br><br>
            <input type="text" name="candidateParty"><br><br>
            Election ID: <br><br>
            <input type="text" name="electionId"><br><br>
